import { Club, Registration, ClubCharterProposal, Announcement, SystemSettings, UserProfile, MeetingAttendanceSession, WebsiteContent } from '../types';
...
export const INITIAL_USERS: Record<string, UserProfile> = {
  ...
  teacher: {
    ...
    role: 'teacher',
    email: 'advisor@kbacademy.edu',
    title: 'Head of Co-Curricular Advisory',
...
export const INITIAL_CLUBS: Club[] = [
  {
    ...
    advisorTitle: 'Head of Co-Curricular Advisory',
...
export const INITIAL_CHARTER_PROPOSALS: ClubCharterProposal[] = [
  {
    ...
    facultyEmail: 'advisor@kbacademy.edu',
...
export const INITIAL_ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    title: 'Regional Qualifier Parts Shipment Arrived in Lab 204',
    content: 'The custom CNC aluminum brackets and optical sensors for the 2026 competition chassis have arrived. Sub-team leads should check inventory before Tuesday practice.',
  ...
  },
  {
    id: 'ann-2',
    clubId: 'system-wide',
    clubName: 'Office of Student Life',
    authorName: 'Mr. Wondwossen Erqiyhun',
    authorRole: 'Highschool Director',
    title: 'Fall Co-Curricular Registration Window Closes in 14 Days',
    content: 'Students must confirm all club enrollments before September 30. Ensure there are no schedule collisions across your primary and secondary registrations.',
    date: 'Sep 16, 2026',
    priority: 'normal'
  },
  {
    ...
    authorRole: 'Faculty Advisor',
    title: 'Tournament Roster Selected for Regional Invitational',
    content: 'Congratulations to our 8 varsity delegates selected for travel. Travel clearance forms must be signed and turned in by Friday.',
    date: 'Sep 15, 2026',
    priority: 'normal'
  }
];
